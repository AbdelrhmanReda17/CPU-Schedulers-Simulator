...
public class Main extends javax.swing.JFrame {
    ...
    public Main() {
        ...
        Process p1 = new Process(0,"P1", Color.RED, 2, 6, 4);
        Process p2 = new Process(1,"P2", Color.BLUE, 5, 2, 9);
        Process p3 = new Process(2,"P3", Color.GREEN, 1, 8, 2);
        Process p4 = new Process(3,"P4", Color.YELLOW, 0, 3, 8);
        Process p5 = new Process(4,"P5", Color.ORANGE, 4, 4, 8);
        p1.setAGFactor(18);
        p2.setAGFactor(17);
        p3.setAGFactor(19);
        p4.setAGFactor(13);
